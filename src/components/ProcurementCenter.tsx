          ...
          <div key={idx} className="bg-slate-900/60 backdrop-blur-md border border-slate-800 rounded-2xl p-6 shadow-lg">
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-sky-400 text-sm mt-1">Supplier: {po.supplier}</p>
              </div>
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button className="px-6 py-2 bg-gradient-to-r from-sky-600 to-cyan-500 hover:from-sky-500 hover:to-cyan-400 text-white font-semibold rounded-lg shadow-md transition-colors text-sm flex items-center space-x-2">
