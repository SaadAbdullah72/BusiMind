        ...
        <div className="flex items-center justify-between mb-8 border-b border-[#1e1e24] pb-5">
          ...
          <div className="flex bg-[#121216]/80 p-0.5 rounded-xl border border-[#1e1e24]">
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer uppercase tracking-wider ${
        ...
        <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="space-y-6">
              <div className="p-6 rounded-xl bg-[#121216] border border-[#1e1e24] space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input required type="email" value={smtpEmail} onChange={e=>setSmtpEmail(e.target.value)} className="w-full bg-[#0a0a0c] border border-slate-700/50 rounded-lg px-4 py-2 text-sm text-slate-250 focus:outline-none focus:border-slate-500 transition-colors" placeholder="support@yourbusiness.com" />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-slate-400 mb-1">App Password (16-char)</label>
                    <input required type="password" value={smtpPassword} onChange={e=>setSmtpPassword(e.target.value)} className="w-full bg-[#0a0a0c] border border-slate-700/50 rounded-lg px-4 py-2 text-sm text-slate-250 focus:outline-none focus:border-slate-500 transition-colors" placeholder="••••••••••••••••" />
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-xl bg-[#121216] border border-[#1e1e24] space-y-4">
                ...
                <div>
                  ...
                  <input required type="email" value={staffEmail} onChange={e=>setStaffEmail(e.target.value)} className="w-full bg-[#0a0a0c] border border-slate-700/50 rounded-lg px-4 py-2 text-sm text-slate-250 focus:outline-none focus:border-slate-500 transition-colors" placeholder="manager@yourbusiness.com" />
                </div>
              </div>
              ...
              <div className="p-6 rounded-xl bg-[#121216] border border-[#1e1e24] space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input required type="email" value={customerEmail} onChange={e=>setCustomerEmail(e.target.value)} className="w-full bg-[#0a0a0c] border border-slate-700/50 rounded-lg px-4 py-2 text-sm text-slate-250 focus:outline-none focus:border-slate-500 transition-colors" placeholder="testcustomer@gmail.com" />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-slate-400 mb-1">Customer App Password</label>
                    <input required type="password" value={customerPassword} onChange={e=>setCustomerPassword(e.target.value)} className="w-full bg-[#0a0a0c] border border-slate-700/50 rounded-lg px-4 py-2 text-sm text-slate-250 focus:outline-none focus:border-slate-500 transition-colors" placeholder="••••••••••••••••" />
                  </div>
                </div>
              </div>
            </div>
          ...
          {activeSubTab === 'layout' && (
            <div className="space-y-6 animate-in fade-in duration-300">
              <div className="p-4 bg-[#121216] border border-slate-700/50 rounded-xl text-[11px] leading-relaxed text-slate-400 flex items-start gap-2.5">
                <span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#0a0a0c] border border-slate-700/50 rounded-lg px-4 py-2 text-sm text-slate-200 focus:outline-none focus:border-slate-500 transition-colors"
                    />
                  </div>
          ...
          <div className="flex justify-end pt-4 border-t border-[#1e1e24] mt-6">
            <button 
              disabled={loading} 
              type="submit" 
              className="px-6 py-2.5 bg-slate-800 hover:bg-slate-700 text-white rounded-xl text-xs font-bold transition-all shadow-lg disabled:opacity-50 cursor-pointer uppercase tracking-wider"
            >
