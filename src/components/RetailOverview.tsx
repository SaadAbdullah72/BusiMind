export default function RetailOverview({ kpis, swot, onScanComplete, scanning }: any) {
  return (
      ...
      <div className="bg-slate-900/60 backdrop-blur-md border border-slate-800 rounded-2xl p-5 shadow-lg mt-5">
        ...
        <ul className="space-y-3">
          {swot.action_steps.map((a: string, i: number) => (
            <li key={i} className="bg-slate-800/50 p-3 rounded-xl text-sm text-slate-200 border border-slate-700/50 flex items-center space-x-3">
